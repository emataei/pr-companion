#!/usr/bin/env python3
"""
DEPRECATED: Generate Optimized PR Impact Heatmap

NOTE: This script is now deprecated. The file change heatmap functionality
has been integrated into the PR Impact Grid generated by generate_development_flow.py.
This script is kept for compatibility but is no longer used in the main workflow.
